...
```{block type="rmdinfo"}
[Try the activity](https://raw.githubusercontent.com/jimhester/wtf-source-package/master/02_source-package_spartan.R) `usethis::use_course("rstd.io/wtf-source-package")`
