...
```{block type="rmdinfo"}
[Try the activity](activities/12-startup-01.R) to learn how to set a GitHub PAT to your .Renviron and then use it to create a gist
```
...
```{block type="rmdinfo"}
[Try the activity](activities/12-startup-02.R) to learn how to create a
.Rprofile with a default CRAN repository and add a startup message to it.
```
...
These are mainly notes for things we need to add and what we wanted to cover
