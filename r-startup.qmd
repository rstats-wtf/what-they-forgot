...
isFlagNoEnvironSet --> |set| isFlagNoSiteFileSet
setEnvUser --> isFlagNoSiteFileSet
doesProjectRenvironExist --> |DNE| isFlagNoSiteFileSet
start --> isFlagNoEnvironSet
...
isFlagNoInitFileSet --> |set| isFlagNoRestoreDataSet
doesUserRprofileExist --> |DNE| isFlagNoRestoreDataSet
runScriptUser --> isFlagNoRestoreDataSet
...
isFlagNoRestoreHistorySet --> |set| running
isFlagNoRestoreHistorySet --> |unset| isEnvRHistifileSet
isEnvRHistifileSet --> |undefined| doesProjectRhistoryExist
doesProjectRhistoryExist --> running
isEnvRHistifileSet & doesProjectRhistoryExist --> loadHistory --> running
