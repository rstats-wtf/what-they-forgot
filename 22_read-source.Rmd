...
```{block type = "rmdinfo"}
[Try activity 1](activities/22_read-source-01.R) to search the R source for code and documentation.
```
...
```{block type = "rmdinfo"}
[Try activity 2](activities/22_read-source-02.R) to search and find source code and documentation in CRAN packages.
```
