...
```{block type ="rmdinfo"}
[Try the activity](activities/21_debugging-r-01.R) to explore using `trace()` with `at`.
```
...
- Debugging shiny (maybe out of scope)
- Debugging activities
- More real world examples
- Using the RStudio debugger features
