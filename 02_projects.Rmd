...
If you use `setwd("path/that/only/works/on/my/machine")` and it does not cause your or your collaborators grief, then I am happy for you. Carry on. This was my practice as well for many years.
