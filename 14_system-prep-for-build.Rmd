...
`r` **cask**. *NOTE: the cask used to be named `r-app` but the `-app` suffix has recently been dropped due [a homebrew policy change around 2019-03-11](https://github.com/Homebrew/homebrew-cask/pull/59689)*. 
